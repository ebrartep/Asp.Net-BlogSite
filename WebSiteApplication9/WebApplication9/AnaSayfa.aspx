<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="WebApplication9.AnaSayfa" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
     ...
     <div class="auto-style13" style="height: auto; width: 690px;background-color:#D67CC8">
        <asp:DataList runat="server" Width="690px" Height="136px" ID="dl_makale" OnSelectedIndexChanged="dl_makale_SelectedIndexChanged">
            <ItemTemplate>
                <div style="margin:0 10px 0 0px;height:auto" class="auto-style17">
                    ...
                    <div style=" line-height: 40px; background-image: url('temalar/mor menu.jpg');" class="auto-style26">
                      ...
                      <a href="makaledetay.aspx?makale_id=<%#Eval("makale_id") %>">  <asp:Label ID="Label1" runat="server" Font-Size="20px" Text='<%# Eval("makale_baslik") %>'></asp:Label></a>
                        ...
                        <div style="border-style: dashed; border-width: 1px 1px 3px 1px; border-color: #CC3399; background-color: #FF99FF; display:inline-block; font-style: normal; font-variant: inherit; text-transform: capitalize; vertical-align: sub; white-space: inherit; height: auto; width: 690px; float: left">
                            <asp:Label ID="Label5" runat="server" Font-Size="18px" Text='<%# Eval("makale_ozet") %>'  width="500px" ViewStateMode="Enabled"></asp:Label>
                        </div>
