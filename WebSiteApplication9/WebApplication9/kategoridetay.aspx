<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="kategoridetay.aspx.cs" Inherits="WebApplication9.kategoridetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="auto-style13" style="height: auto; width: 690px;background-color:#D67CC8">
        <asp:DataList runat="server" Width="690px" Height="136px" ID="dl_kategori" >
            <ItemTemplate>
